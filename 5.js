...
exports.default = {
	...
	tours: [{
		...
		additionalData: {
			include: ['Pick up from your hotel in Puno', 'Transfer to the dock of Lake Titicaca', 'Tourist boat with bathroom facilities', 'Lunch on Taquile Island', 'Drop off to your hotel in Puno', 'All entrance fees', 'English speaking guide'],
			notInclude: ['Extras & gratuities'],
			duration: {
				subtitle: 'over 10 hours (approx.)',
				data: ['Departs at 6:30am', 'Returns at 5:30pm']
			},
			recommendations: ['Warm clothing, gloves, chocolate, water, sunblock'],
			price: {
				currency: '$',
				ammount: 60,
				data: []
