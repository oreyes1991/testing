...
var _articleContentEn = __webpack_require__(157);
...
__webpack_require__(145)("./article." + params.id + '.' + language + '.js').then(function (m) {
    var data = m.default;
    document.title = data.tab_title;
    var html = _articleContentEn2.default.render({ data: data });
