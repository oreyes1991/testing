...
var _articleContentEn = __webpack_require__(180);
...
__webpack_require__(168)("./article." + params.id + '.' + language + '.js').then(function (m) {
    var data = m.default;
    ...
    var html = _articleContentEn2.default.render({ data: data, share: share, uri: uri, share_quote: share_quote });
