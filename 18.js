...
exports.default = {
	...
	tours: [{
		...
		description: 'El r\xEDo Tambopata es uno de los h\xE1bitat exclusivo de las aves y los mam\xEDferos. La flora en la reserva nacional es bastante t\xEDpica del suroeste de la Cuenca Amaz\xF3nica. El r\xEDo Heath y llanuras de los alrededores son un ecosistema \xFAnico en el Per\xFA. Las pampas se inundan peri\xF3dicamente y los peque\xF1os bosques de \xE1rboles con variada vida vegetal crecen en grupos aislados en la llanura.\nSi usted est\xE1 buscando una experiencia m\xE1s profunda del Amazonas, el Centro de Investigaciones Tambopata le convendr\xE1. Despu\xE9s de pasar la primera noche en el Refugio Amazonas, llega al m\xE1s grande conjunto de guacamayos conocido en el segundo d\xEDa de su viaje y explorar los senderos del Centro de Investigaci\xF3n de Tambopata en el coraz\xF3n de la Reserva Nacional Tambopata.',
		additionalData: {
		...
		additionalData: {
			...
			notInclude: ['Extras & gratuities', 'Entrance fees to thermal baths', 'Desayuno', 'Almuerzo'],
			duration: {
				subtitle: '4 días (3 noches)',
				data: ['Salida a las 7:30am desde Cusco']
			},
			recommendations: ['Traer un abrigo para las noches tardes frías de invierno', 'Un poncho impermeable en caso de lluvia', 'Repelente de insectos/mosquitos', 'Toallas', 'Sandalias', 'Gafas de sol', 'Linterna'],
			notes: ['La altitud puede ser un problema para algunas personas - se requiere de buena aptitud física.'],
			price: {
				currency: '$',
				ammount: 260,
				data: []
