...
exports.default = {
  ...
  blocks: [{
    ...
    parragraphs: ['The guano trade in Peru, quixotically, remains after being nearly depleted by over-exploitation. It is unlikely to ever boom again as compared to the nineteenth century, when deposits were 50 feet thick and export earnings accounted for most of the national budget. On most islands, including Asia, located south of the capital, Lima, guano reaches less than 30 inches. But that which remains here is coveted when viewed in the context of the frenzy in Peru and abroad caused by synthetic fertilizers like urea, whose price has doubled in the last year.', '\u201CGuano has the advantage of being free from artificial chemicals\u201D , explains Enrique Balmaceda, producer of organic mangoes in Piura, a northern province of Peru. "The problem is there is not enough to meet demand, now that new products as organic bananas compete for what is available."']
  }, {
    url_image: 'images/articles/guano_collectors_6_t.jpg',
    image_class: 'image-horizontal',
    parragraphs: ['This explains why Peru puts so much effort into preserving the remaining guano, an effort dating back a century, when the country created the Guano Administration Company and nationalized the islands, some of them controlled by the British, to prevent the extinction of guano production. Since then, the Government of Peru restricts harvesting to about two islands per year to allow droppings to accumulate.', 'Guano administrators maintain armed guards on each of the islands, to protect the birds. \u201CFishermen are the most damaging\u201D said Romulo Ibarra, 40, one of the two guards stationed on the uninhabited island Asia. \u201CWhen you approach the island, the motors scare guanays\u201D he says, referring to precious guanay cormorant. \u201CAnd at sea, fishing boats catch anchoveta, something we can not control.\u201D Anchoveta is a 15 centimeter fish belonging to the anchovy family and is the main food of seabirds who leave their droppings in these arid islands.']
  }, {
