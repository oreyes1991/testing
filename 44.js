...
exports.default = {
	...
	activities: [{
		...
		description: 'Montar una bicicleta entre magn\xEDficas monta\xF1as de m\xE1s de 2.000 metros de altitud, zip-line a trav\xE9s de r\xEDos caudalosos, caminata por la selva profunda y luego escalar el pico hasta el santuario de Machu Picchu - esta caminata es lo \xFAltimo en deportes de aventura.\n\t\t\t\t\t\tSu excursi\xF3n guiada te lleva a trav\xE9s de las colinas y valles de la famosa cordillera de los Andes. Usted caminar\xE1 entre antiguas ruinas y ciudades y disfrutar\xE1 de la diversidad de la flora y fauna, \xFAnicas en esta regi\xF3n monta\xF1osa. Su gu\xEDa experto compartir\xE1 cuentos sobre el pueblo inca con usted, adem\xE1s de mantenerle informado acerca de las distintas monta\xF1as, animales y plantas durante el camino.',
		additionalData: {
			...
			duration: {
				...
				data: ['Salida: 7:30am desde Cusco']
			},
			recommendations: ['Lleve una chaqueta o abrigo para las tardes frescas durante el invierno', 'Un poncho impermeable en caso de lluvia', 'Repelente de insectos / mosquitos', 'Toallas', 'Sandalias', 'Gafas de sol', 'Linterna'],
